...
public class ChbSearchAdapter extends ListAdapter<SourceBean, ChbSearchAdapter.ViewHolder> {

    public ChbSearchAdapter(DiffUtil.ItemCallback<SourceBean> diffCallback) {
        super(diffCallback);
    }
